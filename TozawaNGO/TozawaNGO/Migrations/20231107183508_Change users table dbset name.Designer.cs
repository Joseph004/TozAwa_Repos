...
namespace TozawaNGO.Migrations
{
    ...
    [Migration("20231107183508_Change users table dbset name")]
    partial class Changeuserstabledbsetname
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TozawaNGO.Auth.Models.Authentication.UserLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TozawaNGO.Context.TozawangoDbContext+Audit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TozawaNGO.Auth.Models.Authentication.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TozawaNGO.Auth.Models.Authentication.UserHashPwd", b =>
                {
                    b.HasOne("TozawaNGO.Auth.Models.Authentication.ApplicationUser", "ApplicationUser")
                        .WithOne("UserHashPwd")
                        .HasForeignKey("TozawaNGO.Auth.Models.Authentication.UserHashPwd", "UserId")
                        .HasPrincipalKey("TozawaNGO.Auth.Models.Authentication.ApplicationUser", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
