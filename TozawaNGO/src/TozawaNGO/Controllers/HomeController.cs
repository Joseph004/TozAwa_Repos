...
namespace TozawaNGO.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(IAntiforgery antiForgery, IHttpContextAccessor httpContextAccessor, ISpaPrerenderer spaPrerenderer, IServiceProvider serviceProvider, IClusterClient clusterClient, IHostEnvironment env, ILoggerFactory loggerFactory) : base()
        {
            // this.cookie = cookie;
