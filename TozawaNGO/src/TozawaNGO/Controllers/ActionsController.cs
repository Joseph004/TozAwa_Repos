...
namespace TozawaNGO.Controllers
{
    public class ActionsController : Controller
    {
        ...
        public ActionsController(IClusterClient grainClient, IHttpContextAccessor httpContextAccessor, IHostEnvironment env, ILogger<ActionsController> logger) : base()
        {
