...
namespace Tozawa.Bff.Portal.HttpClients
{
    ...
    {
        public AttachmentHttpClient(HttpClient client, AppSettings appSettings, ICurrentUserService currentUserService, ILogger<AttachmentHttpClient> logger) : base(client, appSettings, currentUserService, logger)
        {
        }
    }
}
