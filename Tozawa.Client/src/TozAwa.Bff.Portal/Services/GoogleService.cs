...
namespace Tozawa.Bff.Portal.Services
{
    ...
    public class GoogleService : IGoogleService
    {
        ...
        public GoogleService(AppSettings appSettings, ICurrentUserService currentUserService, IAttachmentHttpClient attachmentHttpClient, ILogger<GoogleService> logger)
        {
            _logger = logger;
