...
namespace OrleansHost.Migrations
{
    ...
    [Migration("20250111173243_updateusertenantlandlord")]
    partial class updateusertenantlandlord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Function", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FunctionType = 3,
                            RoleId = new Guid("8c8812cb-ecb7-4a5a-a97d-309228011c74"),
                        ...
                        {
                            FunctionType = 7,
                            RoleId = new Guid("59651122-b13e-42bd-babb-1f62a2a238c8"),
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = "",
                            ModifiedBy = ""
                        },
                        ...
                        {
                            FunctionType = 9,
                            RoleId = new Guid("222d3077-4d13-4733-8688-57ff43091d69"),
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = "",
                            ModifiedBy = ""
                        },
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f2f2989-215c-4908-9714-708071d166e6"),
                            City = "World",
                        ...
                        new
                        {
                            Id = new Guid("1c909244-0e96-422d-9a76-28c4ac9db8b9"),
                            City = "Kinshasa",
                            CommentTextId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Country = "COD",
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59651122-b13e-42bd-babb-1f62a2a238c8"),
                            OrganizationId = new Guid("1c909244-0e96-422d-9a76-28c4ac9db8b9"),
                            RoleEnum = 1
                        },
                        new
                        {
                            Id = new Guid("222d3077-4d13-4733-8688-57ff43091d69"),
                            OrganizationId = new Guid("1c909244-0e96-422d-9a76-28c4ac9db8b9"),
                            RoleEnum = 2
                        },
                        new
                        {
                            Id = new Guid("8c8812cb-ecb7-4a5a-a97d-309228011c74"),
                            OrganizationId = new Guid("1c909244-0e96-422d-9a76-28c4ac9db8b9"),
                            RoleEnum = 5
                        });
                });
