...
namespace OrleansHost.Migrations
{
    ...
    [Migration("20250109212454_initOrganizationsdata")]
    partial class initOrganizationsdata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Function", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FunctionType = 3,
                            RoleId = new Guid("a78379a8-72df-4885-b3f0-62571088524b"),
                        ...
                        {
                            FunctionType = 7,
                            RoleId = new Guid("e91ea6b8-3e15-4ea9-bb17-dd60e09d9060"),
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = "",
                            ModifiedBy = ""
                        },
                        ...
                        {
                            FunctionType = 9,
                            RoleId = new Guid("4d4e49eb-1099-457a-87ce-0846da6964c2"),
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = "",
                            ModifiedBy = ""
                        },
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1497680-6be8-4e81-a781-2ab1e5c7b80d"),
                            City = "World",
                        ...
                        new
                        {
                            Id = new Guid("aa2dd4d7-001a-479a-9da5-495e8902f710"),
                            City = "Kinshasa",
                            CommentTextId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Country = "COD",
                            CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Grains.Auth.Models.Authentication.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e91ea6b8-3e15-4ea9-bb17-dd60e09d9060"),
                            OrganizationId = new Guid("aa2dd4d7-001a-479a-9da5-495e8902f710"),
                            RoleEnum = 1
                        },
                        new
                        {
                            Id = new Guid("4d4e49eb-1099-457a-87ce-0846da6964c2"),
                            OrganizationId = new Guid("aa2dd4d7-001a-479a-9da5-495e8902f710"),
                            RoleEnum = 2
                        },
                        new
                        {
                            Id = new Guid("a78379a8-72df-4885-b3f0-62571088524b"),
                            OrganizationId = new Guid("aa2dd4d7-001a-479a-9da5-495e8902f710"),
                            RoleEnum = 5
                        });
                });
