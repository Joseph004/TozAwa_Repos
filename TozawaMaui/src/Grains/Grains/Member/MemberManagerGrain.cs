...
namespace Grains
{
    public class MemberManagerGrain([PersistentState("State")] IPersistentState<MemberStates> state) : Grain, IMemberManagerGrain
    {
        private readonly IPersistentState<MemberStates> _state = state;
        ...
        public async Task RegisterAsync(Guid itemKey, MemberItem MemberItem)
        {
