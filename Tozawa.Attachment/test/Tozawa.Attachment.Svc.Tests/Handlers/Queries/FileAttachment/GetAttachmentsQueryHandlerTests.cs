...
public class GetAttachmentsQueryHandlerTests : DatabaseContextDependencyTestsBase
{
#nullable disable
    private GetAttachmentsQueryHandler target;
...
#nullable enable
    ...
    public void Setup()
    {
        ...
        target = new GetAttachmentsQueryHandler(Context,
