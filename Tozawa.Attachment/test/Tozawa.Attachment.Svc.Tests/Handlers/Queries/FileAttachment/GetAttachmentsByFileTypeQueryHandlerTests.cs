...
public class GetAttachmentsByFileTypeQueryHandlerTests : DatabaseContextDependencyTestsBase
{
#nullable disable
    private GetAttachmentsByFileTypeQueryHandler target;
...
#nullable enable
    ...
    public void Setup()
    {
        ...
        target = new GetAttachmentsByFileTypeQueryHandler(Context,
    ...
    public async Task Handle_Get_UnknownOrganizationId_Empty()
    {
        ...
        var query = new GetAttachmentsByFileTypeQuery
        {
            AttachementTypeId = Guid.NewGuid(),
    ...
    public async Task Handle_Get_Returns()
    {
        ...
        var query = new GetAttachmentsByFileTypeQuery
        {
            AttachementTypeId = attachementTypeId,
            OwnerId = ownerId
        };
