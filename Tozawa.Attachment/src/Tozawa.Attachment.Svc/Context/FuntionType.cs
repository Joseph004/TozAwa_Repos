...
namespace Tozawa.Attachment.Svc.Context
{
    public enum FunctionType
    {
        ...
        [EnumMember]
        [Description("r866a9ge-2722-4c47-8a03-8a4ef5650292")]
        [FunctionTypeValues(
           AccessType = AccessType.Read,
           PairId = "8d49e96e-d7bf-453b-ba61-76c21181690b", OnlyVisibleForRoot = false)]
        [JsonConverter(typeof(FunctionTypeConverter))]
        ReadImmovable = 12,

        [EnumMember]
        [Description("t872a7be-2272-4b47-9u03-8a2eu5650292")]
        [FunctionTypeValues(
            AccessType = AccessType.Write,
            PairId = "9c49e96e-d1bf-453b-ba61-36b21111623b", OnlyVisibleForRoot = false)]
        [JsonConverter(typeof(FunctionTypeConverter))]
        WriteImmovable = 13,

         [EnumMember]
        [Description("r866a9ge-3722-4c47-8a03-8a4ev5650292")]
        [FunctionTypeValues(
           AccessType = AccessType.Read,
           PairId = "8d59e96e-d7bf-453b-ba61-76c21181690y", OnlyVisibleForRoot = false)]
        [JsonConverter(typeof(FunctionTypeConverter))]
        ReadTravling = 14,

        [EnumMember]
        [Description("r872a7be-2272-4b47-9u03-8a2eu8650292")]
        [FunctionTypeValues(
            AccessType = AccessType.Write,
            PairId = "9c49h96e-d1bf-453b-ba61-36b21119623b", OnlyVisibleForRoot = false)]
        [JsonConverter(typeof(FunctionTypeConverter))]
        WriteTravling = 15,
    }
}
